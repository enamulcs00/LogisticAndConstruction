...
export class DashboardComponent implements OnInit {
  ...
  getDashboard() {
    let url = 'account/get-count-for-dashboard'
    this.service.get(url).subscribe((res: any) => {
      console.log(res);
      if (res.status == 200) {
        this.dashboardCountData = res.data
      }
    })
  }
  ...
  companyCount: any;
  companyName: any = [];
  // https://logistic-constructionbackend.mobiloitte.com/account/get-company-name
  getCompanyName() {
    let url = 'account/get-company-name'
    this.service.get(url).subscribe((res: any) => {
      console.log(res)
      if (res.status == 200) {
  ...
  getCompanyCount(event) {
    let companyName = event.target.value
    let url = `account/get-count-for-dashboard?companyName=${companyName}`
    this.service.get(url).subscribe((res: any) => {
      console.log(res)
      if (res.status == 200) {
  ...
  supplierCount: any
  supplierName: any = [];
  // https://logistic-constructionbackend.mobiloitte.com/account/get-supplier-name
  getSupplierName() {
    let url = 'account/get-supplier-name'
    this.service.get(url).subscribe((res: any) => {
      console.log(res)
      if (res.status == 200) {
  ...
  // 
  getSupplierCount(event) {
    let supplierName = event.target.value
    let url = `account/get-count-for-dashboard?supplierName=${supplierName}`
    this.service.get(url).subscribe((res: any) => {
      console.log(res)
      if (res.status == 200) {
