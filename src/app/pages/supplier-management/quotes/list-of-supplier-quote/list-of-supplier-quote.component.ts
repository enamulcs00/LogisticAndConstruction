...
@Component({
  selector: 'app-list-of-supplier-quote',
  templateUrl: './list-of-supplier-quote.component.html',
  styleUrls: ['./list-of-supplier-quote.component.css']
})
export class ListOfSupplierQuoteComponent implements OnInit {
...
//--------------------------------pageSize ---------------------------------//
  ...
  ExportToCsv() {
    ...
    this.listing.forEach((element, ind) => {
      let obj = {
        "QuoteId":element.quotesId ? element.quotesId : 'N/A',
    ...
    const options = {
      ...
      headers: ["Company Quotes", "QuoteId", "Company", "Supplier", "Material", "Weight","Location", "Amount", "Delevery Date","Driver Name", "Driver Mobile","Vehicle Number","Vehicle Type","Route Id" ]
    };
    new ngxCsv(dataArr, 'Company Quotes', options);
  }
