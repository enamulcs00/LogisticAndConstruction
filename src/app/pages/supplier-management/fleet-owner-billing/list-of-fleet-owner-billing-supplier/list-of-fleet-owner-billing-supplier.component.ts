...
@Component({
  selector: 'app-list-of-fleet-owner-billing-supplier',
  templateUrl: './list-of-fleet-owner-billing-supplier.component.html',
  styleUrls: ['./list-of-fleet-owner-billing-supplier.component.css']
})
export class ListOfFleetOwnerBillingSupplierComponent implements OnInit {
...
//--------------------------------pageSize ---------------------------------//
  ...
  viewBooking(){
    this.router.navigate(['/view-fleet-owner-billing-supplier'])
  }
